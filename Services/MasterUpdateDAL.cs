...
namespace TMS_Api.Services
{
    public class MasterUpdateDAL
    {
        ...
        //    try
        //    {
        //        Transporter transporter = await _context.Transporter.FromSqlRaw("SELECT Top 1 * FROM Transporter WHERE REPLACE(TransporterID,' ','')=REPLACE(@name,' ','')", new SqlParameter("@name", info.TransporterID)).SingleOrDefaultAsync();
        //        if (transporter != null)
        //        {
        //            msg.Status = false;
        //            msg.MessageContent = "Data Not Found";
        ...
        //            truck.TransporterCode = info.TransporterCode;
        ...
        //            trailer.TransporterCode = info.TransporterCode;
        ...
        //            driver.TransporterCode = info.TransporterCode;
